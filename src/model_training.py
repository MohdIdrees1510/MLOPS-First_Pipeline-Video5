...
#    """Load parameters froma YAML File."""
#    try:
#        with open(params_path, 'r') as file:
#            params = yaml.safe_load(file)
#        logger.debug('Parameters retrieved from %s', e)
#        return params
...
def load_data(file_path: str) -> pd.DataFrame:
    ...
    try:
        ...
        logger.error('Unexpected error occurred while loading the date: %s', e)
        raise
...
def train_model(X_train: np.ndarray, y_train: np.ndarray, params: dict) -> RandomForestClassifier:
    ...
    :return: Trained RandomForestClassfifier
    """
    try:
